...
* from Hello.idl
* 클라이언트 Stub. 클라이언트용으로 기본적인 CORBA 기능 제공.
* Stub을 클라이언트 어플리케이션의 기초로 사용. 
* 클라이언트 코드는 Stub 상에서 구축되어 ORB 기동
* Java IDL 로 제공되는 네임 서비스를 사용한 서버의 룩 업 및 원격 객체의 참조의 취득과 그 메소드의 호출을 실시.
*/
